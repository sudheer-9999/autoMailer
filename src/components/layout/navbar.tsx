...
import Loader from "../login/common/Loader";
    ...
    <nav className="sticky top-0 border-gray-200 bg-white dark:bg-gray-900">
      <div className="mx-auto flex max-w-screen-xl flex-wrap items-center justify-between p-4">
        ...
        <div className="relative flex items-center space-x-3 md:order-2 md:space-x-0 rtl:space-x-reverse">
          ...
          {dropdownOpen && (
            <div
              className="absolute right-0 top-10 z-50 list-none divide-y divide-gray-100 rounded-lg bg-white text-base shadow dark:divide-gray-600 dark:bg-gray-700"
              id="user-dropdown"
            >
